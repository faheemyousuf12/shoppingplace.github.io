    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url(); ?>">The Shopping Place</a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class=""><a href="<?php echo base_url(); ?>">Home</a></li>
              ...
              <li><a class="" href="<?php echo base_url();?>cart">Cart<img src="<?php echo base_url();?>assets/images/products/cart1.png" class="img" alt="Image"/></a></li>
		  </ul>
		  <?php if(!$this->session->userdata('logged_in')) : ?>
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="panel-heading panel-heading-green">
					<h3 class="panel-title">TheShoppingPlace</h3>
				</div>
